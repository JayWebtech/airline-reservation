...
$check_user = "INSERT INTO bookings (fname, sname, state, ffrom, tto, fdate, seats, flight_id, otherguests, amount, email, gsm, re_price) VALUES ('$main_fname','$main_sname','$state','$ffrom','$fto','$fdate','$selectedSeats','$id','$bookingString','$totalprice', '$email', '$gsm', '$mainp')";
