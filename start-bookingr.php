...
$checkbookingx = "SELECT * FROM bookings WHERE id = '$bookingid'";
$checkbookingrunx = mysqli_query($dbcon, $checkbookingx);
$rowx = mysqli_fetch_assoc($checkbookingrunx);
$mainprice = $rowx['amount'];

// while ($rowx = mysqli_fetch_assoc($checkbookingrunx)) {
//     $seatsx = explode(',', $rowx['seats']); // Split the seat numbers in case they are stored as a comma-separated string
//     $bookedseatsArrayx = array_merge($bookedseatsArrayx, $seatsx); // Merge into the main array
// }
// $bookedseatsx = implode(',', $bookedseatsArrayx);
                        ...
                        <div class="col-md-4">
                            ...
                            <h3 style="font-family: Bold;">
                                Total Amount: <span style="font-family: Bold; color: #5cb85c">NGN</span><span
                                    id="totalAmount"
                                    style="font-family: Bold; color: #5cb85c; text-decoration: strikethrough;"><?php echo number_format($amount); ?></span>
                            </h3>
                            ...
                            <input type="hidden" class="form-control" id="totalprice" name="totalprice" required>
                                ...
                                <input type="hidden" name="mainp" value="<?php echo $mainprice; ?>">
        ...
        $(document).ready(function () {
            ...
            $(document).on('submit', '#formadd', function (e) {
                ...
                if (selectedSeats != "") {
                    $.ajax({
                        method: "POST",
                        url: "process-booking2.php",
                        data: $(this).serialize(),
                        success: function (data) {

                            if (data !== "error") {
                                window.open('receipt2.php?id='+data, '_self');
                            } else {
