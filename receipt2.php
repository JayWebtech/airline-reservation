        ...
        <div class="receipt border p-4 rounded">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <?php
                  if ((int)$re_price < (int)$amount) {
                        ?>
                        <p style="color:red"><strong>Your rescheduled booking exceeded the amount of your previoud booking, you have an Outstanding payment of <?php echo abs((int)$re_price - (int)$amount); ?>
                         NGN</strong></p>
    ...
    <script type="text/javascript">
        ...
        function payWithPaystack(e) {
            ...
            let handler = PaystackPop.setup({
                ...
                amount: <?php echo abs((int)$re_price - (int)$amount) ?> * 100,
